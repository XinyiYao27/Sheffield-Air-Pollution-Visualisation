# Sheffield-Air-Pollution-Visualisation
**Student Name:** Xinyi Yao
**Module:** IJC445 Data Visualisation

## 1. Project Overview
This project focuses on visualisation of pollutants in Sheffield to explore how air pollution changes via human and meteorology impacts.
...
## 4. How to Run
1. Clone the code.
2. Run `Data Pre-processing` first, then `Visualisation`.
